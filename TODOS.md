...
- [ ] **Exclude paused and trialing members from Attendance Drop Alert** — Paused subscribers shouldn't appear in the Attendance Drop Alert card since they're on pause and expected not to attend. Trialing subscribers (In Trial) shouldn't appear either since they haven't effectively started their memberships.
