...
- [ ] **Daily export missing lookup tables** — `revenue_categories.csv` and `pass_types.csv` are header-only in daily exports. Need to tell Union CEO this is needed for automated revenue computation. Add to CEO email.
