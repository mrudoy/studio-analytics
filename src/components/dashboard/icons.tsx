...
/** Tabler: brand-speedtest — Usage section */
...
export function BubbleIcon(props: IconProps) {
  return (
    <svg {...iconDefaults(props)}>
      <path d="M12.4 3a5.34 5.34 0 0 1 4.906 3.239a5.333 5.333 0 0 1-1.195 10.6a4.26 4.26 0 0 1-5.28 1.863L7 21v-3.134a2.668 2.668 0 0 1-1.795-3.773A4.8 4.8 0 0 1 8.113 5.16A5.33 5.33 0 0 1 12.4 3" />
    </svg>
  );
}
